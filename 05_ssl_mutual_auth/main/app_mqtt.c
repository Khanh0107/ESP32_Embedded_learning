...
static esp_err_t mqtt_event_handler(esp_mqtt_event_handle_t event)
{
    ...
    switch (event->event_id) {
        case MQTT_EVENT_CONNECTED:
            ...
            // msg_id = esp_mqtt_client_subscribe(client, "/khanhmessi/dht11", 0);
        ...
        case MQTT_EVENT_SUBSCRIBED:
            ...
            // msg_id = esp_mqtt_client_publish(client, "/khanhmessi/dht11", "data", 0, 0, 0);
...
{
    if (cb) {
        mqtt_data_handle = (mqtt_data_handle_t)cb;
    }
}
